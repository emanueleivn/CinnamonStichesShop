...
<form id="RegForm" action="${pageContext.request.contextPath}/Registrazione" method="POST" onsubmit="return validate()">
	<h4>Dati Profilo</h4>
	<label>Nome</label>
	<input class="inp" type="text" id="name"name="nome" placeholder="Nome" 
		required pattern="^[A-Za-z]+$"maxlength="100" title="Inserire il nome,max 50 lettere">
	<label>Cognome</label>
	<input class="inp" type="text" id="surname" name="cognome" placeholder="Cognome" 
...
<input class="inp" type="text" id="via" name="via" placeholder="Via" 
	...
	<label>Città</label> 
	<input class="inp" type="text" id="city"name="city" placeholder="Città" 
